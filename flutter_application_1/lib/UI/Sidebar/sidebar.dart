...
class _SidebarPageState extends State<SidebarPage> with SingleTickerProviderStateMixin<SidebarPage>{
            ...
            children: <Widget>[
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    width: SizeConfig.blockSizeHorizaontal*10,
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      SizedBox(height: SizeConfig.blockSizeHorizaontal*10),
